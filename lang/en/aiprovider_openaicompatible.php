...
$string['action:generate_image:endpoint_desc'] = 'The base URL of the image generation API (falls back to the provider-level endpoint if empty).';
$string['action:generate_image:model'] = 'AI model';
$string['action:generate_image:model_desc'] = 'The model used to generate images (falls back to the provider-level model if empty).';
$string['action:generate_text:endpoint'] = 'API endpoint';
$string['action:generate_text:endpoint_desc'] = 'The base URL of the chat completions API (falls back to the provider-level endpoint if empty).';
$string['action:generate_text:model'] = 'AI model';
$string['action:generate_text:model_desc'] = 'The model used to generate the text response (falls back to the provider-level model if empty).';
...
$string['action:summarise_text:endpoint_desc'] = 'The base URL of the chat completions API (falls back to the provider-level endpoint if empty).';
$string['action:summarise_text:model'] = 'AI model';
$string['action:summarise_text:model_desc'] = 'The model used to summarise the provided text (falls back to the provider-level model if empty).';
...
$string['apiendpoint_desc'] = 'The base URL of the OpenAI-compatible API (e.g. https://api.openai.com/v1). Used as the default for all actions; each action can override it.';
...
$string['model'] = 'Model';
$string['model_desc'] = 'The ID of the model to use (e.g. gpt-4o, claude-3-opus, llama-3). Used as the default for all actions; each action can override it.';
