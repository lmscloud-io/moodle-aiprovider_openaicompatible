...
namespace aiprovider_openaicompatible\form;

use aiprovider_openaicompatible\helper;
...
class action_form extends action_settings_form {
    ...
    protected function definition(): void {
        ...
        $this->providername = $this->_customdata['providername'] ?? 'aiprovider_openaicompatible';
    ...
    public function validation($data, $files): array {
        ...
        if (!empty($data['modelextraparams'])) {
            ...
            if (json_last_error() !== JSON_ERROR_NONE) {
                $errors['modelextraparams'] = get_string('invalidjson', 'aiprovider_openaicompatible');
            }
        }
    ...
    protected function add_model_fields(int $modeltype): void {
        global $PAGE;
        $PAGE->requires->js_call_amd('aiprovider_openaicompatible/modelchooser', 'init');
        $mform = $this->_form;
        ...
        $mform->addElement(
            'select',
            'modeltemplate',
            get_string("action:{$this->actionname}:model", 'aiprovider_openaicompatible'),
